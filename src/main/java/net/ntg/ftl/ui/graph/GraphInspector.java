...
public class GraphInspector extends JToolBar {
	...
	public void setGameState() {
		...
		for (int i = lastCrewSize; i < FTLAdventureVisualiser.playerCrewArray.get(latest).size(); i++) {
			...
			crewPanel.addToggle(CREW_HEALTH, false);
			crewPanel.addToggle(CREW_SKILL_PILOT, false);
			crewPanel.addToggle(CREW_SKILL_ENGINE, false);
			crewPanel.addToggle(CREW_SKILL_SHIELD, false);
			crewPanel.addToggle(CREW_SKILL_WEAPON, false);
			crewPanel.addToggle(CREW_SKILL_REPAIR, false);
			crewPanel.addToggle(CREW_SKILL_COMBAT, false);
