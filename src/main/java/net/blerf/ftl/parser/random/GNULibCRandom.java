...
public class GNULibCRandom implements RandRNG {
    ...
    public static class RandState {
        ...
        public void setRandDeg(int n) {
            randDeg = n;
        }

        public int getRandDeg() {
            return randDeg;
        }

        public void setRandSep(int n) {
            randSep = n;
        }

        public int getRandSep() {
            return randSep;
        }

        public void setTbl(int index, int n) {
            randtbl[index] = n;
        }

        public int getTbl(int index) {
            return randtbl[index];
        }

        public void setStatePtr(int index) {
            statePtr = index;
        }
